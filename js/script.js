...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  aboutBtn.addEventListener("click", function (e) {
    ...
    var yCoordinate = target.getBoundingClientRect().top + window.pageYOffset;
    var yOffset = document.querySelector(".js-nd-vkbiz-header").offsetHeight;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vendor_debounce_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/debounce.js */ "./source/js/vendor/debounce.js");

/* harmony default export */ __webpack_exports__["default"] = (function () {
  var bubbles = document.querySelectorAll(".bubble__text-wrap");
  var mediaQueryDesktopLarge = window.matchMedia('(min-width:1920px)');
  var mediaQueryDesktop = window.matchMedia('(min-width:1280px)');
  var wrap = document.querySelector(".full-page-wrap");
  if (!wrap) return;
  var scrollCallback = Object(_vendor_debounce_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function () {
    if (mediaQueryDesktop.matches) {
      var scrollDistance = wrap.scrollTop;
      var delta = 15;
      ...
      bubbles.forEach(function (elem, i) {
        var target = (elem.offsetTop - scrollDistance) / 85 + i * delta;
        ...
        elem.style.transform = "translateY(".concat(target, "px)");
      });
    }
  }, 10);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vendor_flickity_pkgd_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/flickity.pkgd.js */ "./source/js/vendor/flickity.pkgd.js");
/* harmony import */ var _vendor_flickity_pkgd_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_flickity_pkgd_js__WEBPACK_IMPORTED_MODULE_0__);

/* harmony default export */ __webpack_exports__["default"] = (function () {
  var cases = document.querySelector(".cases__list");
  if (!cases) return;
  var mediaQueryMobile = window.matchMedia('(min-width:768px)');
  var mainTicker = new _vendor_flickity_pkgd_js__WEBPACK_IMPORTED_MODULE_0___default.a('.cases__list', {
    accessibility: false,
    resize: true,
    wrapAround: true,
  ...
  var requestId; // Set initial position to be 0

  mainTicker.x = 0; // Start the marquee animation

  play(); // Main function that 'plays' the marquee.
  ...
  function play() {
    ...
    mainTicker.settle(mainTicker.x); // Set the requestId to the local variable
  ...
  function pause() {
    if (requestId) {
      ...
      window.cancelAnimationFrame(requestId); // Reset the requestId for the next animation.
  ...
  $('.cases__list').on('mouseenter focusin touchstart', function (e) {
    pause();
  }); // Unpause on mouse out / defocus

  $('.cases__list').on('mouseleave touchend', function (e) {
    play();
  });
...
/***/ "./source/js/modules/final-forum.js":
/*!******************************************!*\
  !*** ./source/js/modules/final-forum.js ***!
  \******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var forumMedia = document.querySelector(".final-forum__media");
  if (!forumMedia) return;
  var forumMediaSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](forumMedia, {
    loop: false,
    slidesPerView: 'auto',
    breakpoints: {
      1024: {
  ...
  var forumMediaItems = document.querySelectorAll(".final-forum__media-item[data-paralax]");
  var mediaQueryDesktop = window.matchMedia("(min-width:1024px)");
  var rellax;

  function mediaQueryChecker() {
    if (mediaQueryDesktop.matches === false) {
      forumMediaItems.forEach(function (elem) {
      ...
      if (!rellax) {
        rellax = new rellax__WEBPACK_IMPORTED_MODULE_1___default.a(".final-forum__media-item[data-paralax]", {
          center: true,
          speed: 2
        });
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var gtmBtns = document.querySelectorAll(".gtm-btn");

  var gtmCallback = function gtmCallback(e) {
    var clickType = e.currentTarget.getAttribute("data-gtm");
    dataLayer.push({
      event: clickType
    });
  };
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  document.addEventListener("click", function (e) {
    if (e.target && e.target.classList.contains('video-btn')) {
      ...
      var iframe = _modal.querySelector("iframe");

      iframe.setAttribute("src", modalId);

      _modal.classList.add("modal--show");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var goToSection = function goToSection(e) {
    ...
    var yCoordinate = target.getBoundingClientRect().top + wrap.scrollTop;
    var yOffset = 0;
  ...
  var setActiveItem = function setActiveItem(item) {
    navItems.forEach(function (elem) {
      return elem.classList.remove("main-nav__item--active");
    });
    item.classList.add("main-nav__item--active");
  };

  var setActiveSection = function setActiveSection(item) {
...
/***/ "./source/js/modules/nd-scripts.js":
/*!*****************************************!*\
  !*** ./source/js/modules/nd-scripts.js ***!
  \*****************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/news-from-docs.js":
/*!*********************************************!*\
  !*** ./source/js/modules/news-from-docs.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var newsLists = document.querySelectorAll(".news__list");
  ...
  var slidersInit = function slidersInit() {
    newsLists.forEach(function (elem) {
      var slider = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](elem, {
        loop: false,
        slidesPerView: 'auto',
        spaceBetween: 16,
        observer: true,
  ...
  var tabsLinks = document.querySelectorAll(".tabs__nav-link");
  ...
  var insertDataToSlide = function insertDataToSlide(node, post, index, isLink) {
    var newsText = node.querySelector(".news__desc");
    newsText.insertAdjacentHTML("beforeend", post.text.substr(0, 60) + "...");
    var newsDate = node.querySelector(".news__date");
    ...
    var newsImageUrl = post.image;
    var newsImageNode = node.querySelector("img");
    newsImageNode.setAttribute("src", newsImageUrl);
    newsImageNode.setAttribute("alt", "\u041F\u043E\u0441\u0442 ".concat(index + 1));
    var videoBtn = node.querySelector(".video-btn");
  ...
  var insertSlides = function insertSlides(data) {
    data.forEach(function (post, i) {
      var template = post.link ? "#news-item" : "#news-item--video";
      var isLink = post.link ? true : false;
      var newsItemNode = document.querySelector(template).content.cloneNode(true);
      var target = post.video ? "#streams" : "#posts";
      insertDataToSlide(newsItemNode, post, i, isLink);
      var list = document.querySelector("".concat(target, " .swiper-wrapper"));
  ...
  if (newsLists) {
    var url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSYQC04zek-hFmz5xjVsHVRCeb-wDPyOOjKzp7mNwIZdlJoCp5t9KSWJZQKbLTDLTZ_B3kkr1UvazBU/pub?gid=381082473&single=true&output=csv";
    window.addEventListener("DOMContentLoaded", function () {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var sliders = [];
  newsLists.forEach(function (elem) {
    var slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](elem, {
      loop: false,
      slidesPerView: 'auto',
      spaceBetween: 16,
      breakpoints: {
  ...
  var insertDataToSlide = function insertDataToSlide(node, post, index, isLink) {
    var newsText = node.querySelector(".news__text");
    newsText.insertAdjacentHTML("beforeend", post.text.substr(0, 60) + "...");

    if (isLink) {
      var link = "https://vk.com/wall".concat(post.owner_id, "_").concat(post.id);
      node.querySelector(".news__item").setAttribute("href", link);
    }
    ...
    if (videoBtn && post.attachments[0].type === "video") {
      var video = post.attachments[0].video;
      videoBtn.setAttribute("data-modal", "https://vk.com/video_ext.php?oid=".concat(video.owner_id, "&id=").concat(video.id, "&hash=").concat(video.access_key));
    }

    return node;
  };

  var insertSlides = function insertSlides(target, data, template, isLink) {
    data.response.items.forEach(function (post, i) {
      var newsItemNode = document.querySelector(template).content.cloneNode(true);
      insertDataToSlide(newsItemNode, post, i, isLink);
  ...
  var callbackPosts = function callbackPosts(result) {
    insertSlides(sliders[0], result, "#news-item", true);
  };

  var callbackVideos = function callbackVideos(result) {
...
/***/ "./source/js/modules/parse-data.js":
/*!*****************************************!*\
  !*** ./source/js/modules/parse-data.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony import */ var papaparse__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! papaparse */ "./node_modules/papaparse/papaparse.min.js");
/* harmony import */ var papaparse__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(papaparse__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _schedule_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./schedule.js */ "./source/js/modules/schedule.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var casesWrap = document.querySelector(".schedule__list");
  if (!casesWrap) return;

  var insertText = function insertText(target, selector, text) {
    target.querySelector(selector).insertAdjacentHTML("beforeend", text);
  };

  var innerSliders = [];

  var renderPeriods = function renderPeriods(data) {
    data.forEach(function (periodText) {
      var periodNode = document.querySelector("#schedule-period").content.cloneNode(true);
      insertText(periodNode, ".schedule__period-title", periodText);
      var slideObj = {
        period: periodText,
        innerSlider: new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](periodNode.querySelector(".schedule__items"), _schedule_js__WEBPACK_IMPORTED_MODULE_1__["scheduleInnerSlidersSettings"])
      }; // sliders

      innerSliders.push(slideObj);
      casesWrap.querySelector(".swiper-wrapper").appendChild(periodNode);
    });
    _schedule_js__WEBPACK_IMPORTED_MODULE_1__["periodsSliderSettings"].initialSlide = data.length;
    var periodsSlider = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](casesWrap, _schedule_js__WEBPACK_IMPORTED_MODULE_1__["periodsSliderSettings"]);
  };

  var renderFromData = function renderFromData(data) {
    var result = ""; // get periods
    ...
    var periodsUniq = _toConsumableArray(new Set(periodsAll));

    renderPeriods(periodsUniq); // get cards
    ...
    data.forEach(function (card) {
      ...
      */
      ...
      var membersImages = card.members_images.split(',\n');
      var membersLinks = card.members_links.split(',\n');
      var membersList = "";
      membersImages.forEach(function (image, i) {
        membersList += "<li class=\"members__item\">\n                          <a class=\"members__link\" href=\"".concat(membersLinks[i], "\" target=\"_blank\">\n                            <img src=\"").concat(membersImages[i], "\" alt=\"\u0423\u0447\u0430\u0441\u0442\u043D\u0438\u043A ").concat(i, "\" width=\"50\" height=\"50\" />\n                          </a>\n                        </li>");
      });
      membersList += "<li class=\"members__item\">\n                        <a class=\"members__link members__link--more\" target=\"_blank\" href=\"".concat(card.members_others_link, "\">+").concat(card.members_others_link_text, "</a>\n                      </li>"); // winners

      var winnersImages = card.winners_images.split(',\n');
      var winnersLinks = card.winners_links.split(',\n');
      var winnersTitles = card.winners_titles.split(',\n');
      var winnersList = "";
      winnersImages.forEach(function (image, i) {
        winnersList += "<li class=\"winners__item winners__item--".concat(i + 1, "-place\">\n                          <a class=\"winners__link\" href=\"").concat(winnersLinks[i], "\" target=\"_blank\" title=\"").concat(winnersTitles[i], "\">\n                            <img src=\"").concat(winnersImages[i], "\" alt=\"\u041F\u043E\u0431\u0435\u0434\u0438\u0442\u0435\u043B\u044C ").concat(i, "\" width=\"36\" height=\"36\" />\n                          </a>\n                        </li>");
      }); // cardHtml

      var templateId = "#".concat(status);

      if (status === "schedule-card--active-hiring" || status === "schedule-card--active-members") {
        templateId = "#schedule-card--active";
      }

      var cardHtml = document.querySelector(templateId).content.cloneNode(true);
      var statusTextNode = cardHtml.querySelector(".schedule-card__status");
      ...
      */
      ...
      if (status === "schedule-card--active-hiring") {
        var membersNode = cardHtml.querySelector(".schedule-card__members");
      ...
      if (status === "schedule-card--active-members") {
        var hiringNode = cardHtml.querySelector(".schedule-card__hiring");
      ...
      var periodObj = innerSliders.find(function (x) {
        return x.period === card.period;
      });
  ...
  var url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSYQC04zek-hFmz5xjVsHVRCeb-wDPyOOjKzp7mNwIZdlJoCp5t9KSWJZQKbLTDLTZ_B3kkr1UvazBU/pub?gid=1452801026&single=true&output=csv";
  window.addEventListener("DOMContentLoaded", function () {
    papaparse__WEBPACK_IMPORTED_MODULE_0___default.a.parse(url, {
      download: true,
      header: true,
...
/***/ "./source/js/modules/schedule.js":
/*!***************************************!*\
  !*** ./source/js/modules/schedule.js ***!
  \***************************************/
/*! exports provided: periodsSliderSettings, scheduleInnerSlidersSettings */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "periodsSliderSettings", function() { return periodsSliderSettings; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scheduleInnerSlidersSettings", function() { return scheduleInnerSlidersSettings; });
var periodsSliderSettings = {
  loop: false,
  effect: "fade",
  slidesPerView: 1,
  allowTouchMove: false,
...
var scheduleInnerSlidersSettings = {
  loop: false,
  nested: true,
  slidesPerView: "auto",
  observer: true,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vendor_tools_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/tools.js */ "./source/js/vendor/tools.js");

/* harmony default export */ __webpack_exports__["default"] = (function () {
  var tabsLinks = document.querySelectorAll(".tabs__nav-link");

  var tabsToggle = function tabsToggle(e) {
    e.preventDefault();
    var tabsLink = e.currentTarget;
    var tabsWrap = Object(_vendor_tools_js__WEBPACK_IMPORTED_MODULE_0__["getParents"])(tabsLink, ".tabs")[0];
    var href = tabsLink.getAttribute("href"); // nav

    tabsLink.classList.add("tabs__nav-link--active");
    var othersTabsItems = Object(_vendor_tools_js__WEBPACK_IMPORTED_MODULE_0__["getSiblings"])(tabsLink.parentNode);
    othersTabsItems.forEach(function (item) {
      item.querySelector(".tabs__nav-link").classList.remove("tabs__nav-link--active");
    }); // content

    var newActiveContentItem = tabsWrap.querySelector(href);
    var othersContentItems = Object(_vendor_tools_js__WEBPACK_IMPORTED_MODULE_0__["getSiblings"])(newActiveContentItem);
    newActiveContentItem.classList.remove("tabs__content-item--hide");
    othersContentItems.forEach(function (item) {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var scrollCallback = Object(_vendor_debounce_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function () {
    if (mediaQueryDesktop.matches) {
      var scrollDistance = wrap.scrollTop;
      sections.forEach(function (elem, i) {
        var delta = Number(elem.getAttribute("data-delta")) || 0;
        var target = (elem.offsetTop - scrollDistance) / 8 + delta;
        ...
        var newBgPosition = "calc(50% + ".concat(target, "px) bottom");

        if (elem.id === "section-1") {
          newBgPosition = "left calc(50% - ".concat(target, "px) bottom -2px");
        }

        if (elem.id === "section-5") {
          newBgPosition = "calc(50% + ".concat(target + 50, "px) bottom");
        }
...
/* harmony import */ var _vendor_aos_esm_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/aos.esm.js */ "./source/js/vendor/aos.esm.js");
/* harmony import */ var _vendor_aos_esm_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_aos_esm_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modules_nav_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/nav.js */ "./source/js/modules/nav.js");
...
/* harmony import */ var _modules_bubbles_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/bubbles.js */ "./source/js/modules/bubbles.js");
/* harmony import */ var _modules_waves_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/waves.js */ "./source/js/modules/waves.js");
/* harmony import */ var _modules_gtm_init_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/gtm-init.js */ "./source/js/modules/gtm-init.js");
/* harmony import */ var _modules_nd_scripts_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/nd-scripts.js */ "./source/js/modules/nd-scripts.js");
/* harmony import */ var _modules_cases_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/cases.js */ "./source/js/modules/cases.js");
/* harmony import */ var _modules_about_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/about.js */ "./source/js/modules/about.js");
/* harmony import */ var _modules_final_forum_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/final-forum.js */ "./source/js/modules/final-forum.js");
/* harmony import */ var _modules_tabs_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/tabs.js */ "./source/js/modules/tabs.js");
/* harmony import */ var _modules_news_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/news.js */ "./source/js/modules/news.js");
/* harmony import */ var _modules_modal_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/modal.js */ "./source/js/modules/modal.js");
/* harmony import */ var _modules_parse_data_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/parse-data.js */ "./source/js/modules/parse-data.js");
/* harmony import */ var _modules_news_from_docs_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/news-from-docs.js */ "./source/js/modules/news-from-docs.js");
...
if (document.querySelector(".full-page-wrap")) {
  _vendor_aos_esm_js__WEBPACK_IMPORTED_MODULE_1___default.a.init({
    once: true,
    container: ".full-page-wrap"
  });
}

Object(_modules_nav_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
Object(_modules_intro_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
Object(_modules_bubbles_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
Object(_modules_waves_js__WEBPACK_IMPORTED_MODULE_5__["default"])();
Object(_modules_gtm_init_js__WEBPACK_IMPORTED_MODULE_6__["default"])(); // make-biz

Object(_modules_nd_scripts_js__WEBPACK_IMPORTED_MODULE_7__["default"])();
/*schedule();*/

Object(_modules_cases_js__WEBPACK_IMPORTED_MODULE_8__["default"])();
Object(_modules_about_js__WEBPACK_IMPORTED_MODULE_9__["default"])();
Object(_modules_final_forum_js__WEBPACK_IMPORTED_MODULE_10__["default"])();
Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_11__["default"])(); // news();

Object(_modules_modal_js__WEBPACK_IMPORTED_MODULE_13__["default"])();
Object(_modules_parse_data_js__WEBPACK_IMPORTED_MODULE_14__["default"])();
Object(_modules_news_from_docs_js__WEBPACK_IMPORTED_MODULE_15__["default"])();

/***/ }),

/***/ "./source/js/vendor/aos.esm.js":
/*!*************************************!*\
  !*** ./source/js/vendor/aos.esm.js ***!
  \*************************************/
/*! no static exports found */
...
!function (e, t) {
  ...
  function b(e, n, o) {
    ...
    function y(t) {
      var n = i,
          o = r;
      return i = r = void 0, d = t, c = e.apply(o, n);
    }

    function h(e) {
      var t = e - u;
      return void 0 === u || t >= n || t < 0 || l && e - d >= a;
    }
    ...
    function k() {
      ...
      s = setTimeout(k, function (e) {
        var t = n - (e - u);
        return l ? p(t, a - (e - d)) : t;
      }(e));
    }

    function x(e) {
      return s = void 0, b && i ? y(e) : (i = r = void 0, c);
    }
    ...
    function j() {
      ...
      if (i = arguments, r = this, u = e, t) {
        if (void 0 === s) return function (e) {
          return d = e, s = setTimeout(k, n), f ? y(e) : c;
        }(u);
        if (l) return s = setTimeout(k, n), y(u);
      }

      return void 0 === s && (s = setTimeout(k, n)), c;
    }

    return n = w(n) || 0, g(o) && (f = !!o.leading, a = (l = "maxWait" in o) ? m(w(o.maxWait) || 0, n) : a, b = "trailing" in o ? !!o.trailing : b), j.cancel = function () {
      void 0 !== s && clearTimeout(s), d = 0, i = u = r = s = void 0;
    }, j.flush = function () {
  ...
  function w(e) {
    ...
    e = e.replace(i, "");
    var u = a.test(e);
    return u || c.test(e) ? s(e.slice(2), u ? 2 : 8) : r.test(e) ? n : +e;
  }
  ...
  var y = function y(e, n, o) {
    var i = !0,
        r = !0;
    if ("function" != typeof e) throw new TypeError(t);
    return g(o) && (i = "leading" in o ? !!o.leading : i, r = "trailing" in o ? !!o.trailing : r), b(e, n, {
      leading: i,
      maxWait: n,
      trailing: r
    });
      ...
      N = /^0o[0-7]+$/i,
      q = parseInt,
      S = "object" == _typeof(e) && e && e.Object === Object && e,
      z = "object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self && self.Object === Object && self,
      C = S || z || Function("return this")(),
  ...
  function $(e) {
    ...
    e = e.replace(j, "");
    var n = O.test(e);
    return n || N.test(e) ? q(e.slice(2), n ? 2 : 8) : E.test(e) ? k : +e;
  }
  ...
  var D = function D(e, t, n) {
    ...
    function p(e) {
      var n = e - s;
      return void 0 === s || n >= t || n < 0 || f && e - u >= r;
    }
    ...
    function v() {
      ...
      c = setTimeout(v, function (e) {
        var n = t - (e - s);
        return f ? A(n, r - (e - u)) : n;
      }(e));
    }

    function b(e) {
      return c = void 0, l && o ? m(e) : (o = i = void 0, a);
    }
    ...
    function g() {
      ...
      if (o = arguments, i = this, s = e, n) {
        if (void 0 === c) return function (e) {
          return u = e, c = setTimeout(v, t), d ? m(e) : a;
        }(s);
    ...
    return t = $(t) || 0, H(n) && (d = !!n.leading, r = (f = "maxWait" in n) ? L($(n.maxWait) || 0, t) : r, l = "trailing" in n ? !!n.trailing : l), g.cancel = function () {
      void 0 !== c && clearTimeout(c), u = 0, o = s = i = c = void 0;
    }, g.flush = function () {
      return void 0 === c ? a : b(M());
    }, g;
  },
      P = function P() {};
  ...
  var Q = new (function () {
    ...
    e.forEach(function (e, t) {
      return function (e, t) {
        ...
        }(i, n.animatedClassNames), R("aos:in", i), e.options.id && R("aos:in:" + e.options.id, i), e.animated = !0) : e.animated && !n.once && r();
      }(e, n);
    });
  },
      V = function V(e, t) {
    for (var n = 0, o = 0; e && !isNaN(e.offsetLeft) && !isNaN(e.offsetTop);) {
      n += e.offsetLeft - ("BODY" != e.tagName ? e.scrollLeft : 0), o += e.offsetTop - ("BODY" != e.tagName ? e.scrollTop : 0), e = e.offsetParent === t ? null : e.offsetParent;
    }
    ...
    return o || n;
      ...
      Z = function Z(e, t, n, o) {
    var i = function (e) {
      return e === window ? e.innerHeight : e.clientHeight;
    }(t),
        r = X(e, "anchor"),
        a = X(e, "anchor-placement"),
        c = Number(X(e, "offset", a ? 0 : n)),
        s = a || o,
        u = e;

    r && t === window && document.querySelector(r) ? u = document.querySelector(r) : r && t.querySelector(r) && (u = t.querySelector(r));
    var d = V(u, t).top - i;
    ...
    switch (s) {
      ...
      case "center-center":
        d += i / 2 + u.offsetHeight / 2;
        break;

      case "bottom-center":
        d += i / 2 + u.offsetHeight;
        break;
    ...
    return e.forEach(function (e, o) {
      var i = X(e.node, "mirror", t.mirror),
          r = X(e.node, "once", t.once),
          a = X(e.node, "id"),
          c = t.useClassNames && e.node.getAttribute("data-aos"),
          s = [t.animatedClassName].concat(c ? c.split(" ") : []).filter(function (e) {
        return "string" == typeof e;
      });
      t.initClassName && e.node.classList.add(t.initClassName), e.position = {
        in: Z(e.node, n, t.offset, t.anchorPlacement),
        out: i && function (e, t, n) {
          var o = X(e, "anchor"),
              i = X(e, "offset", n),
              r = e;
          return o && t === window && document.querySelector(o) ? r = document.querySelector(o) : o && t.querySelector(o) && (r = t.querySelector(o)), V(r, t).top + r.offsetHeight - i;
        }(e.node, n, t.offset)
      }, e.options = {
        once: r,
        mirror: i,
    ...
    return document.all && !window.atob;
      ...
      ae = function ae() {
    var e = function (e) {
      if (e instanceof Element || e === window) return e;
    ...
    if (!e) throw "AOS - cannot find the container element. The container option must be an HTMLElement or a CSS Selector.";
    return ne = ee(ne, ie, e), U(ne, e), e.addEventListener("scroll", y(function () {
      U(ne, e);
    }, 99)), ne;
  },
      ce = function ce() {
    arguments.length > 0 && void 0 !== arguments[0] && arguments[0] && (oe = !0), oe && ae();
  },
      se = function se() {
    if (ne = te(), de(ie.disable) || re()) return ue();
    ce();
  },
      ue = function ue() {
  ...
  return {
    init: function init(e) {
      var t, n, o;
      return ie = B(ie, e), ne = te(), t = se, n = window.document, o = new (window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver)(W), P = t, o.observe(n.documentElement, {
        childList: !0,
        subtree: !0,
        removedNodes: !0
      }), de(ie.disable) || re() ? ue() : (document.querySelector("body").setAttribute("data-aos-easing", ie.easing), document.querySelector("body").setAttribute("data-aos-duration", ie.duration), document.querySelector("body").setAttribute("data-aos-delay", ie.delay), -1 === ["DOMContentLoaded", "load"].indexOf(ie.startEvent) ? document.addEventListener(ie.startEvent, function () {
        ce(!0);
      }) : window.addEventListener("load", function () {
        ce(!0);
      }), "DOMContentLoaded" === ie.startEvent && ["complete", "interactive"].indexOf(document.readyState) > -1 && ce(!0), window.addEventListener("resize", D(ce, 50, !0)), window.addEventListener("orientationchange", D(ce, 50, !0)), ne);
    },
    refresh: ce,
    refreshHard: se
  };
...
/***/ "./source/js/vendor/flickity.pkgd.js":
/*!*******************************************!*\
  !*** ./source/js/vendor/flickity.pkgd.js ***!
  \*******************************************/
/*! no static exports found */
...
(function (window, factory) {
  ...
  proto.setTranslateX = function (x, is3d) {
    ...
    this.slider.style.transform = is3d ? 'translate3d(' + translateX + ',0,0)' : 'translate3d(' + translateX + ',0,0)';
  };
...
/***/ "./source/js/vendor/tools.js":
/*!***********************************!*\
  !*** ./source/js/vendor/tools.js ***!
  \***********************************/
/*! exports provided: getParents, getSiblings */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var getParents = function getParents(target, selector) {
  var elements = [];
  var elem = target;
